        ...
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            <a
              ...
              aria-label="GitHub"
              className="flex items-center justify-center w-9 h-9 rounded-lg glass-card border border-[rgba(148,163,184,0.15)] text-slate-400 hover:text-white hover:border-[rgba(148,163,184,0.4)] transition-all duration-200"
            >
